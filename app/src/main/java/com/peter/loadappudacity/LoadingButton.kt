...
class LoadingButton @JvmOverloads constructor(
    ...
    private var buttonColor = ContextCompat.getColor(context, R.color.purple_700)
    private var loadingColor = ContextCompat.getColor(context, R.color.teal_200)
